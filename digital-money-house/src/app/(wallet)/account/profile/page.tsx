    ...
    import { errorAlert, fetchUserData, successAlert } from "@/utils";
    ...
    export default function AccountPage() {
        ...
        useForm<UserInputs>( {defaultValues: userDataFromCookie ?? {} , mode: 'onBlur', } );
        ...
        const onSubmit: SubmitHandler<UserInputs> = async (data)  => {
            ...
            try {
                if (userDataFromCookie) {
                    await updateUser(userDataFromCookie.id, submitData)        
                }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 md:grid-flow-row md:grid-rows-1 lg:grid-cols-4 ">
                        ...
                        <div className="flex justify-between md:col-span-2 lg:col-span-3">
                             <input 
                                    ...
                                    autoComplete="dni"
                                    {...register("dni")}
                                    defaultValue={`${userDataFromCookie?.dni}`}
