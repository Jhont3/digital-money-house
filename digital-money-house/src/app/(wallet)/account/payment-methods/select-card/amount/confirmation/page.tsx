...
export default function ConfirmationPage( ) {
    ...
    return (
        <section className="flex flex-col gap-4 md:col-span-9 md:p-12 md:py-12 md:gap-5 lg:px-20">
            ...
            <div className="bg-green-1 text-black rounded-lg flex flex-col justify-center items-center h-28 gap-2">
                <div><Check/></div>
                <p className="md:text-2xl font-bold">Ya cargamos el dinero en tu cuenta</p>
            </div>
            ...
            <div className="bg-dark-1 text-white rounded-lg px-5 py-4 md:px-14 md:py-12 flex flex-col gap-6">
                ...
                <div>
                    ...
                    <p className="text-green-1 font-bold text-xl">${paymentData.totalAmount || "Cargando..."}</p>
                </div>

                <div>
                    <p className="text-xs pb-1">Para</p>
                    <p className="text-green-1 font-bold text-xl">Cuenta propia</p>
                </div>
